...
const Landing: React.FC = () => {
  return (
    <div className="bg-[#0d1117] text-[#c9d1d9] min-h-screen overflow-x-hidden selection:bg-slate-700 selection:text-white font-sans">
      ...
      {/* REFINED NAVBAR */}
      <nav className="fixed top-0 left-0 right-0 z-[100] py-6 bg-transparent transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <button className="px-5 py-2 text-white font-bold text-[10px] uppercase tracking-widest hover:text-slate-400 transition-colors">Sign In</button>
            <Link to="/register" className="bg-slate-200 hover:bg-white text-black px-5 py-2 rounded-[2px] font-bold text-[10px] uppercase tracking-widest transition-all shadow-lg">Initialize Node</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="relative pt-48 pb-20 px-6 z-10">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-32">
            <button className="bg-white text-black px-10 py-4 rounded-[2px] font-black text-xs uppercase tracking-widest hover:bg-[#f0f0f0] transition-all flex items-center justify-center gap-3 active:scale-95">
      ...
      <section className="py-40 px-6 relative z-10 bg-gradient-to-b from-transparent to-slate-900/40">
        <div className="max-w-4xl mx-auto text-center space-y-10">
           ...
           <button className="bg-white text-black px-12 py-5 rounded-[2px] font-black text-xs uppercase tracking-[0.3em] hover:bg-slate-200 transition-all shadow-2xl active:scale-95">
