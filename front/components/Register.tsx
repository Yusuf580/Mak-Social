    ...
    <div className="flex min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] overflow-x-hidden selection:bg-[var(--brand-color)] selection:text-white font-sans transition-colors duration-500">
      ...
      <div className="hidden lg:block w-1/2 relative bg-[var(--bg-secondary)] dark:bg-[#05080c] border-r border-[var(--border-color)] overflow-hidden">
        <img
          ...
          className="absolute inset-0 w-full h-full object-cover opacity-15 dark:opacity-30 grayscale contrast-125"
          alt="Campus Life"
        />
          ...
          <div className="space-y-12 max-w-lg animate-in slide-in-from-left-8 duration-700">
            <div className="flex items-center gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">
                  Connect with Makerere students today
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-6 bg-white/50 dark:bg-white/10 backdrop-blur-xl rounded-[var(--radius-main)] border border-[var(--border-color)] dark:border-white/10 space-y-3 shadow-2xl group hover:border-[var(--brand-color)]/30 transition-all">
                ...
                <h4 className="text-[11px] font-black text-[var(--text-primary)] dark:text-white uppercase tracking-widest">
                  Study Notes
                </h4>
        ...
        <div className="w-full max-w-md space-y-10 sm:space-y-12">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-full text-slate-500 text-[9px] sm:text-[10px] font-black uppercase tracking-widest shadow-sm">
              <Terminal size={14} className="text-[var(--brand-color)]" /> Start
              Enrollment
            </div>
            <h2 className="text-4xl sm:text-5xl font-black text-[var(--text-primary)] uppercase tracking-tighter leading-none">
              Join Today.
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
            <div className="space-y-5 sm:space-y-6">
              <div className="space-y-2 group">
                <label className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">
                  Full Name
                </label>
                <div className="relative">
                  <UserIcon
                    className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[var(--brand-color)] transition-colors"
                    size={20}
                  />
                  <input
                    type="text"
          ...
          <div className="pt-8 sm:pt-10 border-t border-[var(--border-color)] flex flex-col items-center gap-6 text-center opacity-70 mb-12 sm:mb-0">
            ...
            <p className="text-[8px] sm:text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] sm:tracking-[0.4em] max-w-[320px] leading-loose">
              By joining, you agree to the university digital protocols. We
              protect your data with Makerere security standards.
            </p>
          </div>
        </div>
      </div>
